...
/datum/sex_panel_action/other/penis/vaginal_sex/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
...
/datum/sex_panel_action/other/penis/vaginal_sex/get_pose_text(pose_state)
	switch(pose_state)
