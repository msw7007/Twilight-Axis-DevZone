...
/datum/sex_panel_action/other/penis/butt_job/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
...
/datum/sex_panel_action/other/penis/butt_job/get_pose_text(pose_state)
	switch(pose_state)
