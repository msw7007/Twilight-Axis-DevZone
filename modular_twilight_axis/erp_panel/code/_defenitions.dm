...
#define VAGINA_CHARGE_PER_UNIT 4

#define NYMPHO_PROD_MULT 1.5
#define BAOTIST_PROD_MULT 1.2

#define NYMPHO_PASSIVE_AROUSAL_GAIN 0.5
#define NYMPHO_AROUSAL_SOFT_CAP 20

#define NYMPHO_ORGASM_MULT_GAIN 0.25
#define NYMPHO_ORGASM_MULT_MAX 2.0
